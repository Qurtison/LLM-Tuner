...
export default function MonitorPanel() {
    ...
    return <section className="@container space-y-4" aria-label="Telemetry monitor">
        ...
        <div className="grid gap-2 grid-cols-1">{miniMetrics.map(metric => <MiniChart key={metric.key} metric={metric} points={points} smooth={smooth} master={master} worker={worker} net={net} masterLabel={masterLabel} workerLabel={workerLabel} />)}</div>
