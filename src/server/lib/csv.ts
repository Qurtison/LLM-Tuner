/*
 * Row-level CSV helpers shared by the /api/logs routes and the CSV writer.
 *
...
export function parseNumOrNull(s: unknown): number | null {
...
export function csvQuote(val: unknown): string {
